<?php
return [
    'Filter IP' => 'Фильтр по IP',
    'Filter URI' => 'Фильтр по URI',
    'Date from' => 'Дата от',
    'Date to' => 'Дата по',
    ...
    'Разделенные запятыми подстроки поиска вхождений в IP начинающиеся с первой позиции preg_match(/^needle/,haystack) для исключения из поиска, к примеру 127.0.0.1',
